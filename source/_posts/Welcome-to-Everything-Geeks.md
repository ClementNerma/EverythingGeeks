...
I'll try to commit posting on this blog regularily, but maybe I don't know for how long I'll want to write here, so let's see this site as a little "experiment".
...
My name is Clément Nerma. "Clément" is my real first name, but "Nerma" is actually a pseudonym that comes from the name of a dragon I imagined when I was a child (yeah, that's the first idea that came to my mind when I created this name).
...
But besides of my work, I love studying low-level programming and how computers actually work. How an operating system balances performances between processes, how programs communicate efficiently but in a still "perfecly" (almost) secure way.
